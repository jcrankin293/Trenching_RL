...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, fc1_dims, fc2_dims, n_actions,
                 name, chkpt_dir='C:/Users/Jake Rankin/Documents/Excavator 20190510/Saved Digger'):
        ...
        self.optimizer = optim.Adam(self.parameters(), lr=beta) #try RAdam with optim.RAdam(self.parameters(),lr=0.1)
...
class ActorNetwork(nn.Module):
    def __init__(self, alpha, input_dims, fc1_dims, fc2_dims,
                 n_actions, name, chkpt_dir='C:/Users/Jake Rankin/Documents/Excavator 20190510/Saved Digger'):
        ...
        self.optimizer = optim.Adam(self.parameters(), lr=alpha) #try RAdam with optim.RAdam(self.parameters(),lr=0.1)
        self.device = T.device('cuda:0' if T.cuda.is_available() else 'cpu')
...
class Agent():
    def __init__(self, alpha, beta, input_dims, tau, env,
                 ...
                 layer2_size=300, batch_size=100, noise=0.2):  #update actor was 2 noise was 0.2 max size was 1000000
        self.gamma = gamma
        self.tau = tau
